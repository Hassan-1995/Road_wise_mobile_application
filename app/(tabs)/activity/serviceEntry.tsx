import { serviceLogCreateEntry } from "@/api/serviceEntry";
...
const ServiceLogEntry = () => {
  ...
  const handleServiceEntry = async () => {
    ...
    try {
      ...
      Alert.alert("Error", "Failed to submit service log.");
    }
  };
  return (
    <Screen>
        ...
        >
          <View style={styles.card}>
            ...
            <View style={styles.pickerWrapper}>
              ...
              >
                ...
                <Picker.Item label="Tire Rotation" value="TIRE_ROTATION" />
                <Picker.Item
          ...
          <View style={styles.card}>
            <View style={styles.titleRow}>
              <IconSymbol
                ...
                color={COLORS.secondary}
              />
              <Text style={styles.sectionTitle}>Service Cost</Text>
            </View>
          ...
          <View style={styles.card}>
            ...
            <View style={styles.inputContainer}>
              <TextInput
                style={styles.inputText}
                placeholder="Enter service station or location"
                value={location}
          ...
          <View style={{ margin: 10 }}>
            <AppButton title="Save Repair Entry" onPress={handleServiceEntry} />
          </View>
        </ScrollView>
      </KeyboardAvoidingView>
    </Screen>
